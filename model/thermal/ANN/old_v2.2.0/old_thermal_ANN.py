...
def main():
    ...
    # df_train = standard_labels(df_train, key="T")
    ...
    X_train, X_newMOF, y_train, x_scaler = normalize_data(df_train, df_newMOF, features, ["T"], unit_trans=1, debug=False)
    ...
    regression_target = 'T' # TODO you replaced flag with T
    import tensorflow.keras
    dependencies = {'precision':precision,'recall':recall,'f1':f1}
    model = tensorflow.keras.models.load_model('final_model_T_few_epochs.h5',custom_objects=dependencies)
